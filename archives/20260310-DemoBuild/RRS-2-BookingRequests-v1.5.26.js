/**
 * RRS-2-BookingRequests-v1.5.26
 * BOOKING REQUESTS (new) -> Hold best slot (ranked choices, else smart fallback) + generate confirmation code + update request
 *
 * BUG FIXES: Prevent duplicate BOOKINGS by upserting (update existing booking linked to Booking Request). Also pull Reservation Name from PAID ROSTER {Reservation Name} formula.
 *
 * BEHAVIOR:
 * Priority:
...
// Find existing booking linked to this request
