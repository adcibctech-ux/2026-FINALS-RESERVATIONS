/**
 * RRS-1-SlotImport-v1.10.26 — Bug fix: set singleSelect values via { name: "VALUE" } (Automation-safe)
 *
 * Fixes:
 * - Automations environment rejects setting single select via raw string (e.g., "AVAILABLE")
 * - Uses object form instead: { name: "AVAILABLE" }
 *
 * Behavior:
