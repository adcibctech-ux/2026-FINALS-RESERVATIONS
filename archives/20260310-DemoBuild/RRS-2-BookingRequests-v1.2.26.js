/**
 * RRS-2-BookingRequests-v1.2.26
 * BOOKING REQUESTS (new) -> Hold best slot (ranked choices, else smart fallback) + generate confirmation code + update request
 *
 * BUG FIXES: On FAILED - INVALID EMAIL, also write Confirmation Code + Hold Token + Hold Expires At (for consistent downstream email templates).
 *
 * BEHAVIOR:
 * Priority:
