/**
 * RRS-2-BookingRequests-v1.6.26
 * BOOKING REQUESTS (new) -> Hold best slot (ranked choices, else smart fallback) + generate confirmation code + update request
 *
 * BUG FIXES: Confirmation Code upgraded from 6 to 8 characters to reduce collision risk when matching on a single pasted code.
 *
 * BEHAVIOR:
 * Priority:
